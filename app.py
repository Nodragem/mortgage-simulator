...
c1.write(f"Monthly Payment: :blue[{round(get_monthly_repayment(r, P, N),2)}]")
...
# st.line_chart(df, x="years", y="debt", color='scenario', markers=True)
...
c1.vega_lite_chart(
    ...
    "encoding": {
        "x": {"field": "years", "type":"quamtitative"},
        "y": {"field": "debt", "type": "quantitative"},
